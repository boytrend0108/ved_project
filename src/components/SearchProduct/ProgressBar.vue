<template>
  <div class="progress" v-if="showProgressBar">
    ...
    <my-white-btn 
      ...
      :class="{'disabled': isNextBtnDisables}"
      >Далее  
...
export default {
  ...
  computed: {
    ...mapGetters(["INPUT_VALIDATION_ERR", "INPUT", "COST_CALCULATION_APPL", "STEP", "PROGRESS", "COUNTRY",
                   "CITY", "APPLICATION_NAME", "APPLICATION_DESCRIPTION", "WEIGHT", "CAPACITY", "QUANTITY", 
                  "DOCS", "SERVICES", "ADDRESS_FROM", "SEARCH_PRODUCT_APPL", "COMMENT_FOR_SERVICE"]),
...
.progress__title {
  @include font(17px, 600, #416782);
  line-height: 26px;
}

.span{
  @include font(17px, 600, $main-color);
  line-height: 26px;
}
