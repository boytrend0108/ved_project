<template>
  <div class="successSubscribe">
    <h2 class="title">Вы точно хотите снять заявку с публикации!</h2>
    <p class="title" >За нее уже дерутся исполнители!</p>
    <my-blue-btn class="btn" @click="handler">Снять с публикации</my-blue-btn>
  </div>
</template> 
...
<script>
  ...
  export default { 
    name: 'unpublish-confirmation-form',
    computed: {
      ...mapGetters(["DIALOG"])
    },
    methods:{
